      ...
      var e,
        ...
        D = function () {
          ...
          return (
            ...
            a("<div>")
              ...
              .append(
                a("<table>").addClass("table-condensed").append([b, c, e])
              )
          );
        },
        E = function () {
          var b = a("<div>")
            ...
            e = [D()];
          return (
            z("h") && e.push(b), z("m") && e.push(c), z("s") && e.push(d), e
          );
        },
        F = function () {
          var b = [];
        ...
        G = function () {
          var b = a("<div>").addClass(
            ...
            g = a("<li>")
              .addClass(
                "picker-switch" + (d.collapse ? " accordion-toggle" : "")
              )
              .append(F());
          return (
            ...
            if (g && g.length) {
              ...
              g.collapse
                ...
                e.is("span")
                  ...
                  : e
                      .find("span")
                      .toggleClass(d.icons.time + " " + d.icons.date);
            }
          },
          showPicker: function () {
