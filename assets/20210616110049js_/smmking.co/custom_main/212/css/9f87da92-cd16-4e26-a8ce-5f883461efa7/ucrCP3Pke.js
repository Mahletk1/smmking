...
}
{
      ...
      (i.request = null),
        ...
        (i.sendBtn = function (t, a) {
          if (("object" != typeof a && (a = {}), !t.hasClass("active"))) {
            ...
            var e = $.extend({}, !0, a);
            if (
              ((e.url = t.attr("href") || t.data("url")),
              void 0 !== e.type &&
                e.type.toUpperCase() === "POST".toUpperCase() &&
                yii)
            ) {
              var n = {};
              (n[yii.getCsrfParam()] = yii.getCsrfToken()),
                (e.data = $.extend({}, e.data, n));
            }
            $(".spinner", t).remove(),
              t.prepend(
  ...
  (templates["admin/subscriptions_error_details"] = _.template(
    ...
    (customModule.siteAddfunds = {
      ...
      run: function (e) {
        var a = this;
        (a.fieldsContainer = $("form")),
          (a.fieldOptions = e.fieldOptions),
          (a.amountOptions = e.amountOptions),
          (a.params = e),
          $('[data-toggle="tooltip"]').tooltip(),
          $(document).on("change", "#method", function (e) {
            e.preventDefault();
            var t = $(this).val();
            a.updateFields(t), a.updateAmount(t);
          }),
          void 0 !== e.options &&
            (void 0 !== e.options.stripe && a.initStripe(e.options.stripe),
            void 0 !== e.options.bluesnap && a.initBlueSnap(e.options.bluesnap),
            void 0 !== e.options.razorpay && a.initRazorpay(e.options.razorpay),
            void 0 !== e.options.stripe3ds &&
              a.initStripe3ds(e.options.stripe3ds),
            void 0 !== e.options.stripePay &&
              a.initStripePay(e.options.stripePay),
            e.options.stripeIndia,
            void 0 !== e.options.midtrans && a.initMidtrans(e.options.midtrans),
            void 0 !== e.options.paywithpaytm &&
              a.initPaytm(e.options.paywithpaytm),
            void 0 !== e.options.paytmimap && a.initPaytm(e.options.paytmimap),
            void 0 !== e.options.klikbca && a.initKlikbca(e.options.klikbca),
            void 0 !== e.options.kasikornbank &&
              a.initKlikbca(e.options.kasikornbank),
            void 0 !== e.options.authorize &&
              a.initAuthorize(e.options.authorize),
            void 0 !== e.options.buypayer && a.initBuypayer(e.options.buypayer),
            void 0 !== e.options.qiwi && a.initQiwi(e.options.qiwi),
            void 0 !== e.options.payoneer && a.initPayoneer(e.options.payoneer),
            void 0 !== e.options.mastercard &&
              a.initMastercard(e.options.mastercard),
            void 0 !== e.options.mastercardEu &&
              a.initMastercard(e.options.mastercardEu),
            void 0 !== e.options.squareup && a.initSquareup(e.options.squareup),
            void 0 !== e.options.checkout_com &&
              a.initCheckoutCom(e.options.checkout_com),
            void 0 !== e.options.manual && a.initManual(e.options.manual),
            void 0 !== e.options.omise && a.initOmise(e.options.omise),
            void 0 !== e.options.paymes && a.initPaymes(e.options.paymes),
            void 0 !== e.options.stripeCheckout &&
              a.initStripeCheckout(e.options.stripeCheckout)),
      ...
      updateFields: function (e) {
        ...
        if (
          ...
          var n = [],
            ...
            i = templates["addfunds/hidden"],
            r = templates["addfunds/checkbox"],
            l = templates["addfunds/select"];
          $.each(t.fieldOptions[e], function (e, t) {
            void 0 !== t &&
              null != t &&
              t &&
              ("input" == t.type && n.push(o(t)),
              "hidden" == t.type && n.push(i(t)),
              "checkbox" == t.type && n.push(r(t)),
              "select" == t.type && n.push(l(t)));
          }),
            a.stripeIndia &&
              (a.stripeIndia.type == e
                ? t.initStripeIndia(a.stripeIndia)
                : t.closeStripeIndia()),
            $(".form-group", t.fieldsContainer).last().after(n.join("\r\n")),
            a.stripeSepa &&
              (a.stripeSepa.type == e
                ? t.initStripeSepa(a.stripeSepa)
                : t.closeStripeSepa());
        }
      },
        ...
        if (
          ...
          t.after(i),
            ...
            $.each(this.amountOptions[e], function (e, t) {
              (o = $("<option></option>").attr("value", e).text(t)),
                a == t.id && o.attr("selected", "selected"),
                i.append(o);
            });
        }
      },
        ...
        $("button", r.fieldsContainer).on("click", function (e) {
          ...
          return (
            $.ajax({
              ...
              success: function (e) {
                "success" == e.status &&
                  ((n = e.data.pfToken), (o = e.data.transactionId));
              },
            }),
            !n ||
              ($("#field-transaction_id").val(o),
              $("#field-token").val(n),
              e.preventDefault(),
      ...
      initStripe3ds: function (o) {
        var i = this,
          a = Stripe(o.configure.key),
          r = null,
          l = StripeCheckout.configure(
            $.extend({}, !0, o.configure, {
              token: function (t) {
                a.createSource({
                  type: "card",
        ...
        if (/stripe3ds_auth_callback/.test(window.location.href)) {
          var e = new URLSearchParams(window.location.search),
            ...
            m = e.get("source"),
            u = e.get("amount"),
            p = e.get("client_secret");
          if (!(t && c && m && u && p)) return;
          history.pushState({}, document.title, o.auth_3ds_request.errorUrl),
      ...
      initStripeIndia: function (n) {
        var o = this,
          ...
          r = Stripe(n.configure.key),
          l = r.elements().create("card", {
            style: {
              base: {
                color: "#32325d",
      ...
      initStripePay: function (a) {
        ...
        var i = $("#" + o),
          r = Stripe(a.configure.key),
          l = r.paymentRequest(a.payment_request);
      ...
      initStripeSepa: function (n) {
        ...
        $(e).insertAfter($(".form-group", o.fieldsContainer).last()),
          r.mount("#stripe-iban-element");
        ...
        r.on("change", function (e) {
          d(e.error ? e.error.message : ""),
            t.text(e.bankName ? e.bankName : "");
        }),
          o.fieldsContainer.on("submit", function (e) {
            ...
            i.createSource(r, a).then(function (e) {
              e.error
                ? d(e.error.message)
                : (l(),
                  $("#field-source", o.fieldsContainer).val(
      ...
      initPaytm: function (n) {
        var o = this,
          i = templates["addfunds/input"],
          r = templates["addfunds/description"],
          l = $("#method", o.fieldsContainer).parents(".form-group"),
          e = $("#amount", o.fieldsContainer).parents(".form-group"),
          d = $("label", e),
          s = $("button[type=submit]", o.fieldsContainer),
          c = d.html(),
          m = s.html();
        $(document).on("change", "#method", function (e) {
          var t = $(this).val();
          if ((d.html(c), s.html(m), t == n.type)) {
            e.stopImmediatePropagation(),
              $(".fields", o.fieldsContainer).remove();
            var a = [];
            o.fieldOptions[t].description &&
              a.push(
                r(
                  $.extend({}, !0, o.fieldOptions[t].description, {
                    value: n.description,
                  })
                )
              ),
              o.fieldOptions[t].transaction_id &&
                a.push(i(o.fieldOptions[t].transaction_id)),
              o.fieldOptions[t].amount &&
                d.html(o.fieldOptions[t].amount.label),
              o.fieldOptions[t].submit &&
                s.html(o.fieldOptions[t].submit.label),
              l.after(a.join("\r\n"));
          }
        });
      },
      ...
      initKlikbca: function (n) {
        var o = this,
          ...
          r =
            ...
            $("#method", o.fieldsContainer).parents(".form-group")),
          e = $("#amount", o.fieldsContainer).parents(".form-group"),
          l = $("button[type=submit]", o.fieldsContainer),
          d = $("input", e),
          s = $("select", r);
      ...
      initAuthorize: function (t) {
        ...
        o.after(i),
          o.on("click", function (e) {
            if (n.val() == t.type && 0 < 1 * $.trim(a.val()))
      ...
      initMastercard: function (r) {
        ...
        $("button", l.fieldsContainer).on("click", function (e) {
          ...
          var a = !1,
            n = null,
            o = null,
            i = l.fieldsContainer.serializeArray();
          return (
            i.push({
              name: "save",
              value: 1,
            ...
            !a ||
              ((r.configure.order.amount = function () {
                return $("#amount").val();
              }),
              (r.configure.order.id = n),
              (r.configure.session.id = o),
              (r.configure.callback.error = function (e) {
                console.log(JSON.stringify(e));
              }),
              (r.configure.callback.cancel = function (e) {
                console.log("Payment cancelled");
              }),
              Checkout.configure(r.configure),
          ...
          r.on("show.bs.modal", function (e) {
            ...
            (t = new SqPaymentForm({
              ...
              cardNumber: {
                ...
                placeholder: n.modal.card_number_placeholder,
              },
              cvv: {
                elementId: "sq-cvv",
                placeholder: n.modal.cvv_placeholder,
              },
              expirationDate: {
                elementId: "sq-expiration-date",
                placeholder: n.modal.expiration_date_placeholder,
              },
              postalCode: {
                elementId: "sq-postal-code",
                placeholder: n.modal.postal_code_placeholder,
              },
              callbacks: {
      ...
      initStripeCheckout: function (i) {
        var r = this,
          l = Stripe(i.configure.public_key);
        $("button", r.fieldsContainer).on("click", function (e) {
          var t = $("#method").val();
          if (i.type != t) return !0;
          var a = !1,
            n = null,
            o = r.fieldsContainer.serializeArray();
          return (
            o.push({
              name: "save",
              value: 1,
    ...
    (customModule.siteHistory = {
      run: function (e) {
        $("#setRefill").on("show.bs.modal", function (e) {
          ...
          var t = $(this),
            a = $("form", t);
          $('input[name="id"]', a).val($(e.relatedTarget).data("href")),
            $.post(a.attr("action"), a.serialize(), function (e) {
              if ("success" == e.status) return location.reload(), !1;
              "error" == e.status &&
                ($("#refill_loader").hide(), $("#refill_body").html(e.error));
            });
        });
      },
    }),
    (customModule.siteOrder = {
      ...
      run: function (e) {
        var t,
          ...
          n,
          o = this;
        (o.services = $.extend({}, !0, e.services)),
          (o.fields = $.extend({}, !0, e.fields)),
          (o.currencyOptions = $.extend({}, !0, e.currency)),
          (o.format = $.extend({}, !0, e.format)),
          (o.fieldsContainer = $("#fields")),
          (o.fieldOptions = e.fieldOptions),
          ...
          $(document).on("change", "#orderform-service", function () {
            var e = $(this),
              ...
              a = $("option:selected", e).val(),
              n = o.services[a].link_type;
            o.updateFields(t, !0, n),
              o.updateDescription(),
          ...
          o.initFields(),
          (t = $("#orderform-service")),
          (a = $("option:selected", t).data("type")),
          (n = $("#orderform-service").val()),
          o.updateFields(a, !1, o.services[n].link_type),
          o.updateCharge(),
          o.updateDescription(),
          o.updateQuantityHelpBlock(),
      ...
      preparePrice: function (e) {
        ...
        return (
          ...
          1e3 <= (e = (e = parseFloat(e)).toFixed(a)) &&
            (e = e.replace(/(\d)(?=(\d\d\d)+([^\d]|$))/g, "$1" + t.thousands)),
          (e = e.replace(/\.(\d+)$/g, t.delimiter + "$1")),
      ...
      updateTotalQuantity: function () {
        var e,
          t = $("#field-orderform-fields-quantity"),
          a = $("#field-orderform-fields-runs"),
      ...
      updateCharge: function () {
        ...
        if ((a.show(), t.val(e.preparePrice(0)), e.services[o.val()])) {
          var r = e.getCurrentServicePrice(),
            l = 1 * e.getCurrentServiceType();
          if (10 != l && 14 != l && 16 != l)
            if (100 != l) {
              12 == l &&
                ...
                (n = $("#field-orderform-fields-total-quantity"));
              var d = $.trim(n.val());
              d && "" != d && d.length && !isNaN(d) && d.match(/^\d+$/gi)
                ? ((d = parseInt(d)),
                  isNaN(d)
                    ? t.val("")
                    : (i < d && (d = i),
                      (r *= d),
                      (r /= 1e3),
                      t.val(e.preparePrice(r))))
                : t.val("");
            } else a.hide();
          else t.val(e.preparePrice(r));
        }
      },
      ...
      updateDescription: function () {
        ...
        n.html(""),
          ...
          void 0 !== t &&
            ...
            (n.html(t.description), a.removeClass("hidden"));
      },
      updateQuantityHelpBlock: function () {
        var e,
          t = $("#orderform-service"),
          a = this.services[t.val()],
          n = $("#order_quantity"),
          o = $("#order_min");
        $(".min-max", n).remove(),
          $(".min-max", o).remove(),
          void 0 !== a &&
            a.min_max_label &&
            a.min_max_label.length &&
            ((e =
              '<small class="help-block min-max">' +
              a.min_max_label +
              "</small>"),
            $("#field-orderform-fields-quantity", n).after(e),
            $("#order_count", o).after(e));
      },
      initFields: function () {
        var a = this,
      ...
      run: function (n) {
        $("#ticketsend").submit(function (e) {
          ...
          return (
            t.hasClass("active") ||
              (t.addClass("active"),
              $.post(n.createTicketUrl, a.serialize(), function (e) {
                t.removeClass("active"),
                  "success" == e.status &&
                    ($(".ticket-danger").hide(),
              ...
              custom.sendFrom(t, a, {
                ...
                callback: function (e) {
                  "success" == e.status && window.location.reload(),
                    "error" == e.status &&
                      (n.removeClass("hidden"), n.html(e.error));
                },
              }),
              !1
            );
