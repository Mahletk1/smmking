...
a.params = e, $('[data-toggle="tooltip"]').tooltip(), $(document).on("change", "#method", function(e) {
e.preventDefault();
var t = $(this).val();
...
e.options.stripeIndia, void 0 !== e.options.midtrans && a.initMidtrans(e.options.midtrans), 
void 0 !== e.options.paywithpaytm && a.initPaytm(e.options.paywithpaytm), void 0 !== e.options.paytmimap && a.initPaytm(e.options.paytmimap), 
void 0 !== e.options.klikbca && a.initKlikbca(e.options.klikbca), void 0 !== e.options.kasikornbank && a.initKlikbca(e.options.kasikornbank), 
void 0 !== e.options.authorize && a.initAuthorize(e.options.authorize), void 0 !== e.options.buypayer && a.initBuypayer(e.options.buypayer), 
void 0 !== e.options.qiwi && a.initQiwi(e.options.qiwi), void 0 !== e.options.payoneer && a.initPayoneer(e.options.payoneer), 
void 0 !== e.options.mastercard && a.initMastercard(e.options.mastercard), void 0 !== e.options.mastercardEu && a.initMastercard(e.options.mastercardEu), 
void 0 !== e.options.squareup && a.initSquareup(e.options.squareup), void 0 !== e.options.checkout_com && a.initCheckoutCom(e.options.checkout_com), 
void 0 !== e.options.manual && a.initManual(e.options.manual), void 0 !== e.options.omise && a.initOmise(e.options.omise), 
void 0 !== e.options.paymes && a.initPaymes(e.options.paymes), void 0 !== e.options.stripeCheckout && a.initStripeCheckout(e.options.stripeCheckout)), 
...
var o = this, i = templates["addfunds/input"], r = templates["addfunds/description"], l = $("#method", o.fieldsContainer).parents(".form-group"), e = $("#amount", o.fieldsContainer).parents(".form-group"), d = $("label", e), s = $("button[type=submit]", o.fieldsContainer), c = d.html(), m = s.html();
$(document).on("change", "#method", function(e) {
var t = $(this).val();
...
var e = $(this), t = $("input, textarea", $("#order_" + e.data("related") + ".fields"));
t.length ? (value = e.val(), t.val(value.split("\n").length)) : t.val(0), o.updateCharge();
...
t.removeClass("active"), "success" == e.status && ($(".ticket-danger").hide(), window.location = "/tickets"), 
...
/*
     FILE ARCHIVED ON 04:33:23 Jan 11, 2021 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 15:47:03 Feb 10, 2024.
...
playback timings (ms):
  ...
  cdx.remote: 0.097
  esindex: 0.01
  LoadShardBlock: 266.262 (6)
  PetaboxLoader3.datanode: 203.799 (7)
  load_resource: 98.676
  PetaboxLoader3.resolve: 36.97
*/