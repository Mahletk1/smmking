              ...
              for (
                ...
                if (
                  (v &&
                    (e(q, a, r),
                    null != q.duration &&
                      ((b = q.duration), delete q.duration)),
                  w)
                ) {
                  w = q.startAt = {};
            ...
            set: function (b) {
              ...
              if (this._timeRes) {
                ...
                h =
                  1 === b
                    ? 1
                    : (e + (m - this._s1) / (this._s2 - this._s1)) *
                        this._prec || 0;
              } else
          ...
          var k,
            ...
            V = (function () {
              ...
              return (
                ...
                (o =
                  m && parseFloat(U.substr(U.indexOf("Version/") + 8, 2)) < 6),
            ...
            da = (T.calculateOffset = function (a, b, c) {
              ...
              return (
                a["offset" + d] -
                (ca(a, b, parseFloat(e), e.replace(x, "")) || 0)
              );
            }),
            ea = function (a, b) {
              var c,
            ...
            ia = function (a, b, c) {
              ...
              for (c = c || aa(a, null); --f > -1; )
                (d -= parseFloat(ba(a, "padding" + e[f], c, !0)) || 0),
                  (d -=
                    parseFloat(ba(a, "border" + e[f] + "Width", c, !0)) || 0);
              return d;
            },
            ja = function (a, b) {
                  ...
                  for (
                    ...
                    (z = ha[ya]),
                      ...
                      (c =
                        -1 !== w.indexOf("px")
                          ? parseFloat(w)
                          : ca(this.t, z, parseFloat(w), w.replace(x, "")) ||
                            0),
                      (A =
                        c !== d[z]
                          ? 2 > ya
