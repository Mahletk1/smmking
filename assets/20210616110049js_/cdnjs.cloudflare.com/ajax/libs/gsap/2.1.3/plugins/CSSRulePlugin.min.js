        ...
        return (
                ...
                if (
                  ...
                  d.selectorText &&
                    -1 !==
                      (
                        "," +
                        d.selectorText.split("::").join(":").toLowerCase() +
                        ","
                      ).indexOf(a))
                ) {
                  if (!j) return d.style;
          ...
          (g._onInitTween = function (a, b, d) {
            ...
            return (
              (this._ss = a),
              (this._proxy = f.style),
              (f.style.cssText = a.cssText),
              c.prototype._onInitTween.call(this, f, b, d),
              !0
            );
          }),
          (g.setRatio = function (a) {
            f.call(this, a);
            for (var b = this._proxy, c = this._ss, d = b.length; --d > -1; )
              c[b[d]] = b[b[d]];
          }),
          a.activate([d]),
          d
